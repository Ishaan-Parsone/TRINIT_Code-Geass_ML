...
path = os.path.join(os.path.expanduser('~'), 'Music', 'Road Damage', 'Road-Damage-Detection','web_app','sample_input.mp4')
print (path)
WHITE = (255, 255, 255)
img = None
img0 = None
...
ln_indices = [i - 1 for i in net.getUnconnectedOutLayers()]

# Validate indices to prevent IndexError
ln = net.getLayerNames()
ln = [ln[i] for i in ln_indices if 0 <= i < len(ln)]
