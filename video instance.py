def object_detection(input_video, output_video):
    ...
    weightsPath = "/home/jainisha/yolo.weights"
    configPath = "/home/jainisha/yolov3.cfg"
    ...
    try:
        prop = cv2.CAP_PROP_FRAME_COUNT if not imutils.is_cv2() \
            else cv2.cv.CV_CAP_PROP_FRAME_COUNT
